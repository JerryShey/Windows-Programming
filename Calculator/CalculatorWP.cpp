...
BEGIN_MESSAGE_MAP(CCalculatorWPApp, CWinApp)
...
CCalculatorWPApp::CCalculatorWPApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CCalculatorWPApp 物件

CCalculatorWPApp theApp;


// CCalculatorWPApp 初始設定

BOOL CCalculatorWPApp::InitInstance()
{
